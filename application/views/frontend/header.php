...
<div class="carousel-item">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 image-slider" src="<?= base_url()?>assets/img/slide.jpg" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 image-slider" src="<?= base_url()?>assets/img/slide1.jpg" alt="Second slide">
			 <div class="carousel-caption d-none d-md-block bg-caption">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 image-slider" src="<?= base_url()?>assets/img/slide2.jpg" alt="Third slide">
			 <div class="carousel-caption d-none d-md-block bg-caption">
    <h5>Judul Slider 3</h5>
    <p>Deskripsi Slider 3</p>
  </div>
    </div>
  </div>
